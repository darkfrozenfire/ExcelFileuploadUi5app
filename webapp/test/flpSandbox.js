		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#vendornamespaceproductionplanning-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vendornamespaceproductionplanning-display": {
								"semanticObject": "vendornamespaceproductionplanning",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vendornamespace.productionplanning",
									"url": sap.ui.require.toUrl("vendornamespace/productionplanning")
								}
							}
						}
					}
